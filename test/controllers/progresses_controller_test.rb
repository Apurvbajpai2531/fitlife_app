...
class ProgressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create progress" do
    assert_difference("Progress.count") do
      post progresses_url, params: { progress: { bmi: @progress.bmi, calories_burned: @progress.calories_burned, user_id: @progress.user_id, weight: @progress.weight } }
    end
  ...
  test "should update progress" do
    patch progress_url(@progress), params: { progress: { bmi: @progress.bmi, calories_burned: @progress.calories_burned, user_id: @progress.user_id, weight: @progress.weight } }
